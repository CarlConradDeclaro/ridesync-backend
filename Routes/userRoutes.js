...
import { registerUser, getUsers, logInUser, googleLogin, updateProfile, deleteProfile, updatePassword } from '../Controllers/UserControllers.js';
...
router.post("/updatePasword",updatePassword)
